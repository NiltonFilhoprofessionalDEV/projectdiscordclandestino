  ...
  return (
    <main className="flex min-h-dvh items-center justify-center px-6">
      <form
        ...
        className="w-full max-w-md rounded-3xl border border-white/8 bg-panel/80 p-8 shadow-glow backdrop-blur"
      >
        <p className="font-display text-sm tracking-[0.2em] text-copper uppercase">
          Salas
        </p>
